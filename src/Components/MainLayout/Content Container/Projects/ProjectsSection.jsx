...
const ProjectsSection = forwardRef(({data}, ref) => {
  const [projects, setProjects] = useState(data.ProjectsDisplay);
      ...
      <div>
        ...
        <div className="mt-12">
          <Link to="/archive">
            ...
            >
              <span>
                <span className="border-b border-transparent pb-px transition group-hover:border-secondaryColor motion-reduce:transition-none">
                  View Full Project{" "}
                </span>
